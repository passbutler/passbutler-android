...
class DerivationTest {
    ...
    inner class ServerAuthenticationHashDerivation {
        ...
        fun setUp() {
            ...
            coEvery { RandomGenerator.generateRandomString(SERVER_AUTHENTICATION_HASH_SALT_LENGTH, SERVER_AUTHENTICATION_HASH_SALT_VALID_CHARACTERS) } returns staticSalt
        }
