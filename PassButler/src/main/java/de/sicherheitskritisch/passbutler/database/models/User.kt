        ...
        fun deserialize(jsonObject: JSONObject): User? {
            return try {
                User(
                    ...
                    itemEncryptionPublicKey = jsonObject.getCryptographicKey(SERIALIZATION_KEY_ITEM_ENCRYPTION_PUBLIC_KEY) ?: throw JSONException("The key 'itemEncryptionPublicKey' was not found!"),
